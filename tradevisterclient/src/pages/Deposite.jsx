                            ...
                            <div className="row">
                                <div style={{ borderRadius: "0px" }} className="col-xl-6 p-2 col-sm-6">
                                    ...
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        ...
                                        <h5 onClick={() => handleCopy("16sSqV6xb8jRpCM2h3hW9DAQfResjngvo4")}>16sSqV6xb8jRpCM2h3hW9DAQf...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
                                ...
                                <div className="col-xl-6 col-sm-6 grid-margin mt-5">
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        <div className="card-body card-gradient">
                                        <h5 onClick={() => handleCopy("TGpncWd99wmgBWYipEqfPd8yaZcof1Fo98")}>TGpncWd99wmgBWYipEqfPd8yaZ...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
