...
const Deposite = () => {
    ...
    //16sSqV6xb8jRpCM2h3hW9DAQfResjngvo4
    //TGpncWd99wmgBWYipEqfPd8yaZcof1Fo98
    return (
        <>
            <MainNavBar />
                            ...
                            <div className="row">
                                <div style={{ borderRadius: "0px" }} className="col-xl-6 p-2 col-sm-6">
                                    ...
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        ...
                                        <h5 onClick={() => handleCopy("bc1pjf2msa5s8vqag4dkylccyqa04vr9q6zp5kh7w030vcz4fpschf0sgya3mq")}>16sSqV6xb8jRpCM2h3hW9DAQf...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
                                ...
                                <div className="col-xl-6 col-sm-6 grid-margin mt-5">
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        <div className="card-body card-gradient">
                                        <h5 onClick={() => handleCopy("TAjZkvRtK5cdoG11udBx628Ncw8mPSh2Sc")}>TGpncWd99wmgBWYipEqfPd8yaZ...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
